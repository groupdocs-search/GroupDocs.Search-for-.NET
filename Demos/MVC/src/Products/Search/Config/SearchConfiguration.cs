using GroupDocs.Search.MVC.Products.Common.Config;
using GroupDocs.Search.MVC.Products.Common.Util.Parser;
using GroupDocs.Search.MVC.Products.Common.Util.Directory;
using Newtonsoft.Json;
using System;
using System.IO;

namespace GroupDocs.Search.MVC.Products.Search.Config
{
    /// <summary>
    /// SearchConfiguration
    /// </summary>
