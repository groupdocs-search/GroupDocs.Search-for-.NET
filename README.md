...
This package contains [Examples](https://github.com/groupdocs-search/GroupDocs.Search-for-.NET/tree/master/Examples) and [Showcases](#) for [GroupDocs.Search for .NET](#) that will help you in understanding the API's working and writing your own applications.
